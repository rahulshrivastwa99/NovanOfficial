    ...
    <footer className="bg-foreground text-primary-foreground">
      <div className="container py-16 lg:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
          {/* Shop */}
          <div>
            <h4 className="luxury-button text-primary-foreground/50 mb-6">
              Shop
            </h4>
        ...
        <div className="border-t border-primary-foreground/10 pt-10">
          <div className="max-w-md">
            ...
            <p className="font-body text-sm text-primary-foreground/50 mb-5">
              Early access, exclusive offers, and new arrivals.
            </p>
            <form onSubmit={handleSubscribe} className="flex items-end gap-4">
              ...
              <button
                type="submit"
                className="font-body text-sm text-primary-foreground/70 hover:text-primary-foreground underline underline-offset-4 transition-colors luxury-button"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-primary-foreground/10 mt-10 pt-6 text-center">
          <p className="font-body text-xs text-primary-foreground/40">
            © 2026 Novan. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
